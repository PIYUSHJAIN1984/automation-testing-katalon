...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Frames/h5_iFrame Demo'), 'iFrame Demo')

WebUI.setText(findTestObject('Object Repository/Page_Frames/input_text'), 'test one')
